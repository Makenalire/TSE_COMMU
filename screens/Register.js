...
const Register = () => {
  ...
  const app = initializeApp(authConfig, "Auth");
    ...
    <SafeAreaView style={styles.container}>
      <ImageBackground source={image} resizeMode="cover" style={styles.image}>
        <View style={styles.regForm}>
          ...
          <Text style={styles.tse}>
            TSE <Text style={styles.commu}>COMMU</Text>
          </Text>
          ...
          <View style={styles.password}>
            ...
            >
              <MaterialCommunityIcons
                name={
                  isSecureEntry === false ? "eye-outline" : "eye-off-outline"
                }
                size={20}
                color="lightgrey"
              />
          ...
          <View style={styles.status}>
            <SelectDropdown
              ...
              renderSearchInputLeftIcon={() => {
                return (
                  <FontAwesome name={"search"} color={"#C1C1C1"} size={18} />
                );
              }}
            />
          </View>
          <TouchableOpacity
            onPress={handlerRegister(email, password)}
            style={styles.button}
          >
            <Text style={styles.btnRegister}>SIGN UP</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate("Login", {})}>
            <Text style={styles.btnLogin}>Have account? Log In</Text>
          </TouchableOpacity>
        </View>
      </ImageBackground>
    </SafeAreaView>
